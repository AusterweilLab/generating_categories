...
, in relation to what is already known. That is, when the target category is entirely novel (i.e., no member of the category has been observed), both copy-and-tweak and the hierarchical sampling model essentially generate items at random. 


both the copy-and-tweak and hierarchical sampling models
The copy-and-tweak and hierarchical sampling models predictions about where new categories should be generated in relation to existing category members
