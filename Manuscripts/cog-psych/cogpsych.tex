...
\jlanote{Don't worry about that for now. I'll do a pass on that sort of language later. Lets get the main stuff in here in the right places first.}
...
\jlanote{If we can make a strong case via verbal argument, than yeah. I think we decided not to model it, in which case we shouldn't go into detail on it.}
