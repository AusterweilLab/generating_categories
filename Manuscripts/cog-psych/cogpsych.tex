...
\begin{figure}
    ...
    \caption{PACKER's fit as a function of sensitivity to between-class contrast (using the $\gamma$ parameter). To facilitate comparison, PACKER's other parameters ($c$, $\theta$) were set to the best fitting values obtained for copy-and-tweak in Table \ref{table:global-model-fits}. Thus, in this figure PACKER is equivalent to copy-and-tweak when $\gamma = 1$. }
