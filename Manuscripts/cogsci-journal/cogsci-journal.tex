...
Nolan Conaway\textsuperscript{2}, 
and Kenneth J. Kurtz\textsuperscript{3}
\\[\baselineskip]
\textsuperscript{1}Department of Psychology, University of Wisconsin-Madison, Madison, WI, USA\\
\textsuperscript{2}Shutterstock, New York, NY, USA\\
\textsuperscript{3}Department of Psychology, Binghamton University, Binghamton, NY, USA
\\[1in]
...
\begin{figure}
    \begin{center}
      ...
      \caption{Empirical mean probabilities of generating first Beta exemplars
        ...
        Distances are normalized such that 0 represented the center and 1
