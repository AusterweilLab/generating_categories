...
col_names_short = ['Behavioral']
#col_names_short = ['Behavioral', 'PACKER', 'Copy & Tweak','Representativeness', 'Hier. Bayes','Copy & Tweak Rep']
row_order = ['Bottom-NA', 'Bottom-AB', 'Bottom-ABC','Middle-NA', 'Middle-AB', 'Middle-ABC']
SMOOTHING_PARAM = 0.8


# import data
con = sqlite3.connect('experimentABC.db')
...
fname = 'gradients-t-ABC-' + STAT_OF_INTEREST
